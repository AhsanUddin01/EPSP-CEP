...
#define WIFI_SSID "Dreamnet (( Mooazam ))"
#define WIFI_PASSWORD "Arham123"

#define API_KEY "AIzaSyCXP57KHkwT2s8mSw6rEOQUMwfoQyscJgk"
#define DATABASE_URL "epsp-cep-ahsan01-default-rtdb.firebaseio.com"
